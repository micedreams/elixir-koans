defmodule Structs do
  ...
  koan "Use the put_in macro to replace a nested value" do
    ...
    assert put_in(airline.plane.maker, :airbus) == %Structs.Airline{name: "Southwest",
  ...
  koan "Use the update_in macro to modify a nested value" do
    ...
    assert update_in(airline.plane.passengers, fn x -> x + 2 end) == %Structs.Airline{name: "Southwest",
    plane: %Structs.Plane{passengers: 202, maker: :boeing}}
  end
